...
const UI_ICONS := {
	...
	"areas": "res://assets/art/ui/nav/areas.png",
	"build": "res://assets/art/ui/nav/build.png",
	"history": "res://assets/art/ui/nav/history.png",
	"credits": "res://assets/art/ui/nav/credits.png",
