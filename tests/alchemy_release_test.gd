...
func _ready() -> void:
	...
	check(project.contains('config/version="1.5.1"'), "project version is 1.5.1")
	check(export.contains("version/code=22"), "Android version code is 22")
	check(export.contains('version/name="1.5.1"'), "Android version name is 1.5.1")
