...
func _ready() -> void:
	...
	check(project.contains('config/version="1.5.3"'), "project version is 1.5.3")
	check(export.contains("version/code=24"), "Android version code is 24")
	check(export.contains('version/name="1.5.3"'), "Android version name is 1.5.3")
